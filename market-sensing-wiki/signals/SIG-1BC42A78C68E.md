...
!!! success "포착할 기회"
    ...
    **조건:** 관찰 기준은 ‘신규·갱신 계약에 엄격 적용’입니다.

    **사업 효과:** 예상 사업 효과는 ‘유럽 선택권 가치 차등’입니다.

    **선제 행동:** 우선 행동은 ‘데이터 조항 표준화’입니다.

!!! danger "방어할 위험"

    **조건:** 관찰 기준은 ‘2028~2030 강도 기준이 비용에 반영’입니다.

    **사업 효과:** 예상 사업 효과는 ‘고배출 물량 할인·전환 제한’입니다.

    **방어 행동:** 우선 행동은 ‘생산지별 메탄 포트폴리오 관리’입니다.

!!! warning "미실행 기회비용"

    ‘데이터 조항 표준화’ 대응을 늦추면 ‘유럽 선택권 가치 차등’ 기회를 놓치고, ‘고배출 물량 할인·전환 제한’ 상황이 현실화된 뒤에야 대응할 수 있습니다.

**결정 전환 조건:** ‘신규·갱신 계약에 엄격 적용’ 조건이 확인되면 기회 대응을 시작하고, ‘2028~2030 강도 기준이 비용에 반영’ 조건이 확인되면 방어 결정으로 전환합니다.

## 유럽 판매선택권을 가르는 계약상 데이터 권리
...
포스코인터내셔널의 LNG 물량이 유럽으로 직접 향하지 않더라도 목적지 전환권은 포트폴리오 가치의 일부입니다. 메탄 원산지·경로·측정자료를 연결하지 못하면 가격차가 벌어져도 유럽 전환이 지연되거나 비용이 늘 수 있습니다. 신규 계약과 갱신 건은 가격조건과 함께 데이터 제공, 독립검증, 위반 책임을 묶어 검토해야 합니다.

## 계약 단위 선택권과 검증수준의 판별 체계
...
## 원산지·메탄 데이터·감사권 연결의 경고 기준

**반증 조건:** 계약별 원산지·메탄 데이터·감사권의 연결표를 확인해 주요 EU 수입국이 요구하는 동등성 또는 검증요건과 데이터 권리를 전 물량이 충족하면 경고를 낮추고, 신규계약 통관에 생산지별 Level 5 검증을 실제 요구하는데 이를 충족하지 못하면 강화합니다.

**확인 담당:** LNG 계약 담당은 체결·갱신일과 데이터 제공·감사권을, 생산·환경 담당은 OGMP 2.0 보고수준과 독립검증 범위를, EU 규제 담당은 회원국별 집행지침과 벌칙을 확인합니다.

**감지 트리거:** 주요 EU 수입국이 신규계약 통관에 생산지별 Level 5 검증을 실제 요구하거나 2026년 데이터베이스 공개항목과 회원국 집행지침이 구체화되면 유럽 판매선택권을 다시 판단합니다.
...
```impact-simulator
{"schema_version":1,"title":"EU 메탄 검증의 LNG 마진 노출","description":"검증자료 미비로 EU 판매선택권이 제한될 때의 연간 LNG 마진 노출입니다.","as_of":"2026-08-19","confidence":"low","notice":"공개자료와 넓은 AI 가정을 결합한 방향·민감도용 예비 계산입니다. POSCO의 실제 물량·가격·원가·계약조건 또는 공식 전망이 아니며 관련 Signal과 동일한 충격은 중복 합산하지 않습니다.","formula_display":"EU 연계 물량 × 단위마진 × 판매제한 비율 × 미완화율","variables":[{"id":"volume","label":"EU 연계 LNG 물량","unit":"Mt/년","min":0.1,"max":5,"step":0.1,"default":1,"kind":"assumption","basis":"계약별 생산지·도착지 물량으로 교체할 가정","source_ids":[]},{"id":"margin","label":"LNG 단위마진","unit":"USD/t","min":10,"max":150,"step":5,"default":60,"kind":"assumption","basis":"트레이딩·터미널 비용 전 단위마진 가정","source_ids":[]},{"id":"restricted","label":"판매제한 비율","unit":"fraction","min":0,"max":1,"step":0.05,"default":0.2,"kind":"assumption","basis":"MRV·검증자료 미비로 영향받는 계약 비중","source_ids":[]},{"id":"unmitigated","label":"미완화율","unit":"fraction","min":0,"max":1,"step":0.05,"default":0.5,"kind":"assumption","basis":"대체 판매처·데이터 보완 후 남는 비율","source_ids":[]}],"outputs":[{"id":"net_impact","label":"연간 EBITDA 노출","unit":"USD m","decimals":1,"primary":true,"expression":{"op":"multiply","args":[{"var":"volume"},{"var":"margin"},{"var":"restricted"},{"var":"unmitigated"}]}}],"presets":[{"id":"defense","label":"방어","values":{"volume":0.41500000000000004,"margin":27.5,"restricted":0.06999999999999999,"unmitigated":0.175}},{"id":"base","label":"기준","values":{"volume":1,"margin":60,"restricted":0.2,"unmitigated":0.5}},{"id":"pressure","label":"압박","values":{"volume":3.6,"margin":118.5,"restricted":0.72,"unmitigated":0.825}}]}
```
