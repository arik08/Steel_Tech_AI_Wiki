...
**반증 조건:** 동일 용선 품질 기준의 광종별 총현금원가입니다. HyREX 실증에서 중·저품위 분광 사용과 생산성·품질·원가가 동시에 검증되면 기회 판단을 강화합니다. 고품위 펠렛 공급이 충분히 확대되거나 HyREX의 추가 전력·슬래그 비용이 원료 절감을 넘으면 약화합니다.

**확인 담당:** HyREX 실증 운영·원료구매·기술제휴 담당입니다.

**감지 트리거:** 광종별 환원율·생산성·슬래그·전력소비 또는 직접환원용 펠렛 프리미엄이 총현금원가의 우위를 바꾸는 수준으로 확인되면 재판단합니다.
