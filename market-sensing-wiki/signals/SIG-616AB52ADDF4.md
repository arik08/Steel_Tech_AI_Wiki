...
!!! success "포착할 기회"
    ...
    **조건:** 관찰 기준은 ‘소유·지배권이 적격이고 금지기업 관련 비용이 낮으며 공급자 인증 확보’입니다.

    **사업 효과:** 예상 사업 효과는 ‘45X 공제 대부분을 사업경제성에 반영 가능’입니다.

    **선제 행동:** 우선 행동은 ‘시설·공급자별 증빙 체계 확정’입니다.

!!! danger "방어할 위험"

    **조건:** 관찰 기준은 ‘법인 지배권 또는 핵심 공정·재료가 금지기업 제한에 해당’입니다.

    **사업 효과:** 예상 사업 효과는 ‘공제 상실과 일정 지연이 동시에 발생 가능’입니다.

    **방어 행동:** 우선 행동은 ‘구조 변경안과 공제 제외 기준 투자안 병행 비교’입니다.

!!! warning "미실행 기회비용"

    ‘시설·공급자별 증빙 체계 확정’ 대응을 늦추면 ‘45X 공제 대부분을 사업경제성에 반영 가능’ 기회를 놓치고, ‘공제 상실과 일정 지연이 동시에 발생 가능’ 상황이 현실화된 뒤에야 대응할 수 있습니다.

**결정 전환 조건:** ‘소유·지배권이 적격이고 금지기업 관련 비용이 낮으며 공급자 인증 확보’ 조건이 확인되면 기회 대응을 시작하고, ‘법인 지배권 또는 핵심 공정·재료가 금지기업 제한에 해당’ 조건이 확인되면 방어 결정으로 전환합니다.

## 미국 현지 생산과 45X 적격성의 분리

**판단 질문:** 미국 내 리튬 생산이라는 이유만으로 생산비의 10% 상당인 45X 세액공제를 사업경제성에 반영해도 되는가?
...
## 적격 생산비와 공급망 증빙의 이중 관문

**확인된 변화:** IRS의 2025년 12월 개정 Form 7207 지침은 2025년 7월 4일 이후 시작하는 과세연도에 새로운 금지 외국기업 제한이 적용된다고 명시했습니다. 리튬은 탄산리튬·수산화리튬으로 전환하거나 질량 기준 99.9% 이상으로 정제할 때 적격 핵심광물이 될 수 있습니다. 2026년 2월 Notice 2026-15 발표는 물질적 지원 비용비율과 임시 안전기준을 제시했고, 향후 안전기준 표가 나올 때까지 이를 사용할 수 있다고 밝혔습니다. 정책 변화는 공제율 자체보다 공제를 받을 수 있는 비용의 범위와 증빙 책임을 바꿨습니다.
...
**사업 영향:** 미국 실증이 기술적으로 성공해도 금지 외국기업 판정이나 공급자 인증 실패로 공제 기반이 줄면 예상 현금원가가 올라갑니다. 반대로 법인 지배권과 공급망을 초기에 정리하면 세액공제를 고객 가격에 얼마나 반영할지 협상할 선택지가 생깁니다. 포스코홀딩스는 미국 직접리튬추출 실증과 후속 사업의 기술성 검증에 앞서 법인·공급망·인증 구조가 세액공제 요건을 통과하는지 확인해야 합니다. 핵심 변수는 명목 10% 공제율보다 `적격 생산비`와 `비적격 비용 비중`입니다.
...
**반증 조건:** 미국 사업의 장비·재료·라이선스 비용을 공급자별로 나눈 원가명세를 검토했을 때 관련 법인과 공급망이 모두 적격이고 물질적 지원 비용이 임시 안전기준보다 충분히 낮다고 확인되면, 세액공제를 아직 반영하면 안 된다는 결론을 폐기합니다.

**확인 담당:** 미국 사업의 세무·법무·구매 담당

**감지 트리거:** IRS의 새 안전기준 표 발표, 금지 외국기업 정의 변경, 미국 실증의 법인·공급자 변경 또는 고객 장기계약 체결 시 재평가합니다.
