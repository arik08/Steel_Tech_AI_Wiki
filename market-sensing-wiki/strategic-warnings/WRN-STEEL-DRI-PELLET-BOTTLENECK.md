...
**POSCO**{ .signal-pill .signal-pill-company .signal-company-name aria-label="회사 POSCO" } **철강**{ .signal-pill .signal-pill-axis aria-label="사업축 철강" } **기술·운영**{ .signal-pill .signal-pill-type aria-label="변화 유형 기술·운영" }
{ .signal-detail-context .strategic-issue-context aria-label="회사, 사업축과 변화 유형" }

# 3~4%뿐인 고품위 철광석이 수소환원제철 경쟁을 가른다

**이 이슈의 위치** · **경영 Function:** 구매·공급망 · 기술·연구개발 · 생산·운영 · **지역·시장:** 글로벌 DR급 펠렛 시장 · 한국 HyREX 실증 · **시간:** HyREX 실증부터 상업설비 원료계약 전

**왜 우리 회사 이슈인가 · 핵심 관심** · HyREX 실증 원료, 광종별 전처리·에너지·슬래그 비용, 장기 원료계약과 기술제휴 가치가 직접 노출됩니다. **바꿀 결정:** HyREX 실증의 핵심 지표에 광종별 총현금원가와 펠렛 회피가치를 포함할지 결정해야 합니다.

??? info "회사 연결 근거"

    **공식 사업 근거:** 포스코는 HyREX의 분광 사용 원료경로를 공식 기술축으로 추진해 DR급 펠렛 가격과 원료 유연성이 기술경제성에 직접 연결됩니다.

    **전달 경로:** DR급 펠렛 희소성과 프리미엄이 경쟁공정 원가를 높일 때 HyREX 원료 유연성의 회피가치와 상업화 우선순위가 달라집니다.

    **회사 공식 원문:** [[sources/SRC-20260819-E8EA9DEC|회사 공식 근거 1]]

!!! warning "관찰 · 활성 · 기회"

    **판단 질문:** HyREX 실증의 핵심 판단지표에 광종별 총현금원가와 펠렛 회피가치를 포함할 것인가?

    **잠정 결론:** HyREX의 투자·기술제휴 기준에 광종별 원료비와 공급가능량을 넣어 원료 유연성을 숫자로 검증해야 합니다.

    **다음 사업 분기점:** 2027년 3월까지 HyREX 실증의 광종별 생산성·품질·총현금원가 비교

**세 숫자로 읽는 시장 전환**

| **3~4 %** | **현재 개발방향** | **2025년 5월 20일** |
| ---: | ---: | ---: |
| 직접환원급 해상 철광석 비중 | 변화 시점 | 변화 시점 |
| 수소와 별개로 원료 품질이 전환의 병목임을 보여줍니다. | POSCO가 HyREX의 분광 활용 경로를 공식 설명 | OECD가 직접환원급 해상 철광석 비중 3~4%와 원료 병목을 제시 |
| [[sources/SRC-20260819-CE5F863E|근거 1]] | [[sources/SRC-20260819-E8EA9DEC|근거 1]] | [[sources/SRC-20260819-CE5F863E|근거 1]] |

**직접환원급 원료 프리미엄이 제조원가를 얼마나 늘리는가**

**읽는 법:** 직접환원급 원료비와 사용량에 따라 제조원가 노출이 커져, 광종별 실증원가가 기술 성공의 핵심 숫자가 됩니다.
{ .strategic-quant-lead }

| 시나리오 | 연간 원료비 증가 | 고품위 펠렛 프리미엄 | 펠렛 미대체율 |
| --- | --- | --- | --- |
| 방어 | 2.71 USD m | 10.5 USD/t | 24% |
| 기준 | 58.8 USD m | 30 USD/t | 70% |
| 압박 | 662 USD m | 75.5 USD/t | 90% |

_단위 표 안에 표시 · 기준일 2026-08-19 · 회사 실제값이 아닌 민감도 · [[sources/SRC-20260819-CE5F863E|근거 1]] · [[sources/SRC-20260819-E8EA9DEC|근거 2]]_

_계산·범위: DRI 생산량 × 원료투입계수 × 펠렛 프리미엄 × 미대체율 공개자료와 넓은 AI 가정을 결합한 방향·민감도용 예비 계산입니다. POSCO의 실제 물량·가격·원가·계약조건 또는 공식 전망이 아니며 관련 Signal과 동일한 충격은 중복 합산하지 않습니다._

## 수소환원제철 경쟁의 숨은 제약, 직접환원급 펠렛 부족

현재 직접환원급 원료는 해상물량 100 가운데 약 3.5에 불과합니다. 전통 DRI가 요구하는 67% 초과 철 함량과 희소한 공급 비중이 함께 작동하므로 원료 프리미엄은 수소비와 별도 변수입니다.
...
상단 정량표는 직접환원급 원료비와 사용량에 따라 제조원가 노출이 커져, 광종별 실증원가가 기술 성공의 핵심 숫자가 됩니다. 단위와 기준일을 확인하고, 회사 실제 실적 전망이 아닌 민감도 결과로 읽어야 합니다.
...
| --- | --- | --- |
| **기회** | 직접환원급 펠렛 부족과 가격 프리미엄이 지속되는 가운데 HyREX의 분광 사용 성능·품질·총원가가 상업 규모에서 입증 | **효과:** 원료 유연성이 저탄소 철강의 독립 경쟁우위가 되어 원료비 절감과 기술제휴·라이선스 선택권을 확대<br>**행동:** 광종별 실증 데이터를 공개 가능한 검증 패키지로 만들고 원료·기술을 묶은 제휴안을 설계 |
| **위험** | 고품위 펠렛 공급이 빠르게 늘거나 HyREX의 생산성·품질·총원가 검증이 지연 | **효과:** 원료 유연성의 차별가치가 줄고 실증·설비투자 회수와 기술제휴 일정이 늦어짐<br>**행동:** 수소·효율 중심 비교안을 병행하고 상업 검증 단계별 투자 중단 기준을 적용 |
...
| --- | --- | --- |
| 1 · 포스코 기술연구원·철강전략·원료구매 | 경쟁공정과 광종별 총원가를 동일 기준으로 비교합니다. | 두 번째 검증으로 이동 |
| 2 · 포스코 기술연구원·철강전략·원료구매 | 실증 공개지표를 기술제휴 단계조건에 연결합니다. | 대안의 경제성과 실행 가능성 비교 |
| 3 · 포스코 기술연구원·철강전략·원료구매 | 2027년 3월까지 HyREX 실증의 광종별 생산성·품질·총현금원가 비교 | 투자·계약·보류 중 하나를 선택 |
...
| --- | --- | --- |
| 1 · 포스코 기술연구원·철강전략·원료구매 | 광종별 실증에서 생산성·품질·원가가 함께 검증됩니다. | 상업 실증에서 원료 유연성의 비용효과가 사라집니다. |
| 2 · 포스코 기술연구원·철강전략·원료구매 | 직접환원용 펠렛 프리미엄이 추가 상승합니다. | 펠렛 공급부족이 해소됩니다. |
| 3 · 포스코 기술연구원·철강전략·원료구매 | 2027년 3월까지 HyREX 실증의 광종별 생산성·품질·총현금원가 비교 | 반증 조건이 확인되면 이슈 강도를 낮춥니다. |
...
| 이슈 강화 | 이슈 완화 |
| --- | --- |
| 광종별 실증에서 생산성·품질·원가가 함께 검증됩니다. | 상업 실증에서 원료 유연성의 비용효과가 사라집니다. |
| 직접환원용 펠렛 프리미엄이 추가 상승합니다. | 펠렛 공급부족이 해소됩니다. |
