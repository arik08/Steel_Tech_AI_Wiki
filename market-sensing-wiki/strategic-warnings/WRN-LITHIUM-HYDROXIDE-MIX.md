...
| 지표 | 현재 확인값 | 기준일 | 해석 | 근거 |
| --- | ---: | --- | --- | --- |
| 세계 전기차 배터리 LFP 비중 | **55% 초과** | 2025-12-31 | LFP가 보조 화학계를 넘어 세계 주류가 되었음을 보여줍니다. | [[sources/SRC-20260819-3F479FFE|원문 1]] · [[sources/SRC-20260819-C39C1B19|원문 2]] |
| LFP 팩의 NMC 대비 평균 가격 격차 | **40% 초과 저렴** | 2025-12-31 | 완성차가 대중차·저가차에서 LFP를 채택할 경제적 압력이 커졌습니다. | [[sources/SRC-20260819-3F479FFE|원문 1]] · [[sources/SRC-20260819-C39C1B19|원문 2]] |
| 미국 내 LFP 전환 생산능력 | **50 GWh 초과** | 2025-12-31 | 낮은 미국 사용비중과 별개로 현지 공급망 전환이 시작됐습니다. | [[sources/SRC-20260819-3F479FFE|원문 1]] |
| GM 스프링힐 LFP 상업생산 목표 | **2027년 말** | 2025-07-14 | 비중국 대형 완성차의 실제 고객행동으로 추세의 전달 가능성을 확인합니다. | [[sources/SRC-20260819-55D3797D|원문 1]] |
...
```mermaid
flowchart TB
    A["외부 변화 · LFP 중심으로 배터리 화학계 구성이 이동"]
    B["전제 변화 · 총 리튬 성장률과 수산화리튬 성장률의 분리"]
    C["사업 영향 · 수산화 설비의 가동률과 증설 회수기간이 먼저 흔들리는 구조"]
    D["판단 · 2027~2030 사업계획을 제품별 계약과 전환능력 중심으로 재편"]
    A --> B --> C --> D
```
...
| --- | --- | --- |
| **기회** | LFP 확대와 함께 탄산리튬 수요가 늘고 기존 설비·원료의 제품 전환 가능성이 확인 | 총 리튬 수요 성장을 탄산·수산화 제품별 판매와 전환 서비스로 나눠 새로운 고객 수요를 확보 고객·지역·화학계별 장기수요를 다시 계산하고 전환투자와 계약 조건을 제품별로 설계 |
| **위험** | 북미까지 LFP 양산이 확대되지만 수산화리튬 중심 증설·판매계획이 그대로 유지 | 수산화리튬 가동률과 가격 가산분이 낮아져 단일제품 증설의 회수기간이 길어짐 수산화리튬 증설의 단계 집행 기준과 탄산 전환 선택지를 경영안건으로 재심의 |
...
**권고 시한:** 2026-10-31 · **담당:** 포스코홀딩스 리튬사업·전략·마케팅 공동 검토
