...
포스코 철강, 포스코홀딩스 리튬·전략광물, 포스코인터내셔널 에너지 사업축에 영향을 주는
...
- `설정된 사업축에서 사업영향도와 긴급도가 높은 변화를 조사해줘.`
...
| `market-sensing-wiki/index.md` | 사업영향도·긴급도 순 Signal과 설정된 사업축을 보여주는 시작 화면 | 자동 생성, 직접 수정 금지 |
